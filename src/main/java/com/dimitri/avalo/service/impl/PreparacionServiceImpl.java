...
public class PreparacionServiceImpl implements PreparacionService {
    ...
    @Override
    public List<Preparacion> listarPorFecha(LocalDate fecha) {
      return preparacionRepository.findAllByFechaPreparacionAndActivaTrue(fecha);
    }
    @Override
    public Preparacion guardarPreparacion(Preparacion preparacion) {
      return preparacionRepository.save(preparacion);
    }
}
